...
let
  ...
  tools = builtins.abort (String.toString merged_tools_set)/*validate (Dict.values merged_tools_set)*/;
  ...
  null-ls-tools = builtins.abort (String.toString tools) List.filter (item: item.type != "language-server") tools;
